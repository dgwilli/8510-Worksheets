...
>It appears that most SOTU addresses given by modern presidents are speeches, whereas a lot of earlier presidents rendered theirs in writing. 
...
head(Reagan_tf_idf)
```
>THIS IS WHERE YOU NEED TO PUT YOUR ANSWER. 
...
file_paths <- list.files("MindAndBody/")
MAB <- readtext(paste("MindAndBody/", file_paths, sep=""))  
```
